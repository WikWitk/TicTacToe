...
from playerAI import GeniusComputerPlayer


class TicTacToe:
    def __init__(self):
        self.board = [' ' for _ in range(9)] # we will use sigle list to rep 3x3 board
    ...
    def winner(self, square, letter):
        ...
        # check diagonals(ukosna,przekotna)
        #but olny if the square is an even number(0,2,4,6,8)
